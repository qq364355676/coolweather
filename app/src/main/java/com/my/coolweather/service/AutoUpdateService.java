...
import com.my.coolweather.receiver.AutoUpdateReceiver;
...
public class AutoUpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        long anHour = 8*60*60*1000;//8小时毫秒数
        long triggerAtTime = SystemClock.elapsedRealtime()+anHour;//SystemClock.elapsedRealtime()从手机开机到当前时间
